    ...
    <footer className="bg-dark text-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <Logo className="h-10 mb-4" light />
            <p className="text-gray-400">Your one-stop shop for the latest and greatest in electronics. Based in {settings.location}.</p>
          </div>
          <div>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 text-center text-gray-400 text-sm">
          ...
          <Link to="/admin" className="ml-4 hover:text-white">Admin Panel</Link>
        </div>
      </div>
    </footer>
  );
